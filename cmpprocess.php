...
<div class="art-layout-wrapper clearfix">
    ...
    <br>
 <table align="center">
<form action="cmpser.php" method="post">
<tr><td>Enter Compliant No</td><td><input type="text" name="cmpno"  /></td><td><input type="submit" name="cmpser" value="Search" /></td></tr>
</form>
</table>
<br>
<h2 align="center">Pending Compliants</h2>

<table border="1" align="center">
<tr><td>Compliant No</td><td>Customer Name</td><td>Customer Mobile</td><td>Problem</td><td>Date of Register</td><td>Status</td></tr>

<?php
$sql="select * from system WHERE status='Pending'";
