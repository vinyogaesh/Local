...
<div class="art-layout-wrapper clearfix">
    ...
    <h2 class="art-postheader">Compliant Management</h2>
  <table border="1" align="center">
<tr><th>Compliant No</th><th>Select</th><th>Retrive</th></tr>
<?php


	$sql="Select * from system WHERE deleted='Y'";
   ...
   while($row=mysql_fetch_array($ans))
{
  ...
  // $status=$row['status'];
   ...
   ?>
<form action="undelinv.php" method="post">
  
<tr><td><?php echo $uname;?></td><td><input type="radio" name="undelname" value="<?php echo $id; ?>"/></td><td><input type="submit" name="undel" value="Retrive" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
