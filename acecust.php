...
$sql="INSERT INTO custdetail (custname, custaddress, custmobile, custmailid, adtime,deleted)
VALUES('$_POST[custname]','$_POST[custaddress]','$_POST[custmobno]','$_POST[custmail]',NOW(),'N')";
echo $id;
...
//  alert('Invoice Created Sucessfully Invoice No:- ' )
 ...
 $cname;
//$pack=$_POST['package'];
$sql="select * from custdetail where custname='$cname'";
...
$ans=mysql_query($sql);
   while($row=mysql_fetch_array($ans))
   {
	...
	echo"The Customer:- <b>". $name . "</b>  Customer No Is:-<b> ".$no."</b><br><br>";
	  echo"<a href='crecust.php'>Back</a>";
   }
mysql_close($con)
?>
  </div>
