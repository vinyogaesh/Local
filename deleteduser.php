...
<?php
	...
	$sql="Select * from user WHERE deleted='Y' and block='N'";
   ...
   while($row=mysql_fetch_array($ans))
{
  ...
  // $status=$row['status'];
   ...
   ?>
<form action="undel.php" method="post">
...
<tr><td><?php echo $uname;?></td><td><?php if($utype=='10')
 {
	 ...
	 {
		 echo"Employee";
	 }?></td><td><input type="radio" name="undelname" value="<?php echo $id; ?>"/></td><td><input type="submit" name="undel" value="Retrive" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
