...
<div class="art-layout-wrapper clearfix">
    ...
    <h2 class="art-postheader">Staff's Management</h2>
...
<tr><td>Select User Type :-</td><td><select name="utype"><option value="">----Select----</option>
...
<tr><td></td><td><input type="submit" name="creuse" value="Create User" /></td></tr>
</form>
</table>
</body>
</html>
...
if(!$_POST['creuse'])
{
	echo"<b><center>Please Press Create User Button.......</center></b>";
}
else
{
...
$utype=$_POST['utype'];
$sql="INSERT INTO user (uname,pass,utype,deleted)
VALUES('$uname','$pass','$utype','N')";
//echo $id;
if (!mysql_query($sql,$con))
  ...
  //echo $a;
  //?>
  <?php  echo "<b>User Registerd Sucessfully........! </b><br><br>";
  echo"User Name is:-<b>".$uname."</b>";
}
  
?>
<br /><br /><br />
<a href="accm.php">Back</a>
