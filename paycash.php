...
<div class="art-layout-wrapper clearfix">
    ...
    <h2 class="art-postheader">Bill Payment Details</h2>
    <?php

$cmpno=$_POST['cmpno'];
$stat=$_POST['stat'];
//$note=$_POST['note'];
$servpri=$_POST['servchar'];
//$servengname=$_POST['servengname'];
$sql="UPDATE system SET payper='$servpri',paystat='Paid',status='Deliverd' WHERE cmpno='$cmpno'";

if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
  echo "<b>Cash Paid Sucessfully........! </b><br><br>";
  echo"Complaint No is:-<b>".$cmpno."</b>";
  
?>
<br /><br /><br />
<a href="comppay.php">Back</a>
