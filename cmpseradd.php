...
$stat=$_POST['stat'];
$note=$_POST['note'];
$servpri=$_POST['servcharprice'];
$servengname=$_POST['servengname'];
$sql="UPDATE system SET status='$stat',note='$note',servchar='$servpri',serveng='$servengname',updated='Y' WHERE cmpno='$cmpno'";
...
if (!mysql_query($sql,$con))
  ...
  ?>
  <?php  echo "<b>Compliant Updated Sucessfully........! </b><br><br>";
  echo"Complaint No is:-<b>".$cmpno."</b>";
  
?>
<br /><br /><br />
<a href="cmpprocess.php">Back</a>
