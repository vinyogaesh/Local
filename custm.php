...
<div class="art-layout-wrapper clearfix">
 ...
 <table width="387" height="48" align="center">
<tr><td width="117"><strong><a href="edcust.php">Edit Customer </a></strong></td><td width="125"><strong><a href="delcust.php">Delete Customer</a></strong></td><td width="118"><strong><a href="retcust.php">Deleted Customer</a></strong></td></tr>
</table>
    <h2 class="art-postheader" align="center">Customer Details</h2>

<table border="0" align="center">
<tr><th>Customer No</th><th>Customer Name</th><th>Customer Address</th><th>Customer Mobile</th><th>Customer Mail-ID</th></tr>
<?php

	$sql="Select * from custdetail WHERE deleted='N'";
   ...
   while($row=mysql_fetch_array($ans))
{
   ...
   $custmail=$row['custmailid'];
  // $status=$row['status'];
    
   ?>
<tr><td><?php echo $custno;?></td><td><?php echo $custname;?></td><td><?php echo $custaddress;?></td><td><?php echo $custmob;?></td><td><?php echo $custmail;?></td></tr>
...
<br /><br /><br />
<a href="dashboard.php">Back</a>  </div>
</div>
<div class="art-content-layout">
    <div class="art-content-layout-row">
