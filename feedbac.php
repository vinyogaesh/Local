...
<nav class="art-nav clearfix">
    <ul class="art-hmenu"><li><a href="index.php"class="active">Home</a></li><li><a href="rcomp.php" >Register Compliant</a></li><li><a href="searchcomp.php" >Search Compliant</a></li><li><a href="cmpstatus.php">Status</a><li><a href="contact.php">Contact</a></li></li></ul> 
    </nav>
	<br><br />
	<marquee direction="left" scrollamount="3" onmouseover="this.stop();" onmouseout="this.start();"><a href="feedbac.php">Feed Back</a></marquee>
<div class="art-layout-wrapper clearfix">
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content clearfix"><article class="art-post art-article">
                        <br>
                                <h2 class="art-postheader">Give Your Feed Back</h2>
    ...
    <br>
        ...
        <table align="center">
<tr>
	<td><h2>Enter Your Name</h2></td>
	<td><input type="text" name="custname" /></td>
</tr>
<tr>
	<td><h2>Enter Your E-Mail</h2></td>
	<td><input type="text" name="custmail"  /> </td>
</tr>
<tr>
	<td><h2>Enter Your Message</h2></td>
	<td><textarea cols="25" rows="5" name="message"></textarea></td>
</tr>
<tr>
	<td><h2>To Department</h2></td>
	<td><select name="to"><option value="------Select-----">------Select-----</option>
