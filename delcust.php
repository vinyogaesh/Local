...
<div class="art-layout-wrapper clearfix">
    ...
    <h2 class="art-postheader">Customer Management</h2>
...
<tr><td><?php echo $custno;?></td><td><?php echo $custname;?></td><td><input type="radio" name="delname" value="<?php echo $custno; ?>"/></td><td><input type="submit" name="del" value="Delete" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
