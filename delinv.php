...
<tr><th>Compliant No</th><th>Select</th><th>Delete</th></tr>
<?php
   ...
   while($row=mysql_fetch_array($ans))
{
  ...
  // $status=$row['status'];
   ...
   ?>
<form action="delin.php" method="post">
  
<tr><td><?php echo $uname;?></td><td><input type="radio" name="delname" value="<?php echo $id; ?>"/></td><td><input type="submit" name="del" value="Delete" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
