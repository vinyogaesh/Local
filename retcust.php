...
<div class="art-layout-wrapper clearfix">
    ...
    <h2 class="art-postheader">Deleted Customer Details</h2>
    <table border="1" align="center">
<tr><th>Customer No</th><th>Customer Name</th><th>Select</th><th>Delete</th></tr>
<?php


	$sql="Select * from custdetail WHERE deleted='Y' ";
   ...
   while($row=mysql_fetch_array($ans))
{
   ...
   ?>
<form action="custret.php" method="post">
  
<tr><td><?php echo $custno;?></td><td><?php echo $custname;?></td><td><input type="radio" name="retname" value="<?php echo $custno; ?>"/></td><td><input type="submit" name="ret" value="Retrive" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
