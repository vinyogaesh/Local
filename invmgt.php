...
<h2 align="center">Compliant's Management</h2>

<table align="center" border="1">
<tr><td><a href="delinv.php">Delete Compliants</a></td><td><a href="deletedinv.php">Deleted Compliants</a></td></tr>
</table>

<br />

<table border="1" align="center">
<tr><th>Compliant No</th><th>Compliant Name</th></tr>
<?php
   ...
   while($row=mysql_fetch_array($ans))
{
  ...
  // $status=$row['status'];
   ...
   ?>
<tr><td><?php echo $utype;?></td><td><?php echo $uname;?></td></tr>
