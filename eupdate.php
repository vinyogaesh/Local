...
$cmpno=$_POST['custno'];
$stat=$_POST['custname'];
$note=$_POST['custaddress'];
$servpri=$_POST['custmobno'];
$servengname=$_POST['custmail'];
$sql="UPDATE custdetail SET custname='$stat',custaddress='$note',custmobile='$servpri',custmailid='$servengname' WHERE custno='$cmpno'";
...
<?php  echo "<b>Customer Updated Sucessfully........! </b><br><br>";
  echo"Customer No is:-<b>".$cmpno."</b>";
  
?>
<br /><br /><br />
<a href="custm.php">Back</a>
