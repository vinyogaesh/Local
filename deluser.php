...
<tr><th>User Name</th><th>User Type</th><th>Select</th><th>Delete</th></tr>
<?php
...
<tr><td><?php echo $uname;?></td><td><?php if($utype=='10')
 {
	 ...
	 {
		 echo"Employee";
	 }?></td><td><input type="radio" name="delname" value="<?php echo $id; ?>"/></td><td><input type="submit" name="del" value="Delete" /></td></tr>
</form>
<?php }
mysql_close($con)
?>
